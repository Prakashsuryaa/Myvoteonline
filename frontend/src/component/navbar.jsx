  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex items-center bg-[#FBF6F6] rounded-2xl px-4 py-2 border border-gray-300">
          <FaSearch className="text-[#165887] mr-2" aria-label="Search" />
          <input
            type="text"
            placeholder="Search Electoral Roll"
            className="bg-transparent outline-none text-[#165887] text-sm w-full"
          />
        </div>
      </nav>
    </>
